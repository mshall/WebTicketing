...
INSERT INTO `complaint` VALUES (1,'Hitrd initial comment','mohamed.s.elshall@gmail.com',1,1,'+971505338183','2018-07-27 19:12:06','2018-07-27 19:12:06','Open',1,'Side node','No action taken'),(2,'second complaint','mohamed.s.elshall2011@gmail.com',1,1,'+971505338183','2018-07-27 23:00:00','2018-07-27 23:50:00','Closed',1,'Side note','No action taken'),(3,'first complaint','shall@gmail.com',1,1,'+201015595938','2018-08-07 01:17:10',NULL,'Open',4,'','');
/*!40000 ALTER TABLE `complaint` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `marchent_rollpaper`
--

DROP TABLE IF EXISTS `marchent_rollpaper`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `marchent_rollpaper` (
  `id` int(11) NOT NULL auto_increment,
  `roll_paper_id` int(11) default NULL,
  `merchant_id` int(11) default NULL,
  `roll_paper_out_number` int(11) default NULL,
  `meet_sla` varchar(45) default NULL,
...
--
-- Dumping data for table `marchent_rollpaper`
--
...
INSERT INTO `merchant` VALUES (1,'Mr. Merchant','merchant@gmail.com','2222','','Dubai','Dubai st','505338183','2010155959','Spectra','Mohamed S. El-Shall','5589','438888','A','USD');
...
INSERT INTO `rollpaper` VALUES (1,'Small',1000,1),(2,'Medium',1000,1),(3,'Large',1000,1);
...
INSERT INTO `terminal` VALUES (1,'22334',1,1,132413,12341,'USD','A','Stocked','2018-07-27 19:12:06','',NULL,'','','','','','','','','','','','','','H branch','2018-07-27 19:12:06');
...
-- Dump completed on 2018-08-07  2:26:45
