					...
					<div class="col-sm-6 col-sm-offset-3 form-box">
						<div class="form-top">
							...
							<div class="HomeLogo">
								...
								<h3>
									<fmt:message key="login_to_our_site" />
								</h3>
						...
						<div>
							<p id="form-message" style="font-size: 1.2em;"></p>
						</div>
						<div class="form-bottom">
							<form action="Login" Method="POST" class="login-form">
								<div class="form-label-group">
									<label class="sr-only"><fmt:message key="username" /></label>
									<input type="text" required="true" id="uname" name="uname"
										placeholder="Username..." class="form-username form-control"
										id="form-username">
								</div>
								<br>
								<div class="form-label-group">
									<label class="sr-only"><fmt:message key="password" /></label>
									<input type="password" required="true" id="password" name="psw"
