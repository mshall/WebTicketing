				...
				<div class="panel-body">
					<div class="row">
						<label class="control-label col-sm-2"><fmt:message
								key="sim_number" /></label> <input type="text" id="serialNum"
							placeholder="Enter SIM serial number" class="col-sm-4"
					...
					<div class="row">
						<label class="control-label col-sm-2"><fmt:message
								key="operator" /></label> <select id="operator" class="col-sm-4"
							style="border-radius: .5rem"
					...
					<div>
						...
						<button class="btn btn-success" onclick="print($('#allSim'))">
					...
					<table id='simTable' class='table responsive' border='1'>
						<thead>
							<tr>
								...
								<th><fmt:message key="pos_serial" /></th>
