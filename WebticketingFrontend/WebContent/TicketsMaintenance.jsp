		...
		<div id="content">
			...
			<div class="panel-group">
				...
				<div class="panel-body">
					<form name="Maintainenace" action="Maintainenace" method="POST"
						...
						<div class="panel-body">
							...
							<div class="row">
								<label class="control-label col-sm-2"><fmt:message
										key="solution" />: </label> <input class="col-sm-4" type="text"
									id="complaintSolution" name="solution"
						...
						<div class="form-group">
							<div class="col-sm-offset-4 col-sm-8">
								<input type="button" value="<fmt:message key="submit" />"
									...
									onclick="window.location.replace('InboxTickets.jsp');" class="btn btn-danger" />
							</div>
						</div>
						<br> <br>
					</form>
