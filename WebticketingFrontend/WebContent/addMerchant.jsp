                ...
                <div class="panel-body   ">
                    <form action="MerchantControll" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="mName" placeholder="Merchant Name"
                                       required="" value="<c:out value="${user.getmName()}"/>">
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="p1" placeholder="Phone 1" required
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="p2" placeholder="Phone 2"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="City" placeholder="City"
                                       value="<c:out value="${user.getCity()}" />">
                            </div>
                        </div>
                        <div class="form-group ">
                            <label class="control-label col-sm-4"><fmt:message key="Street"/></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="st" placeholder="Street"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number " class="form-control" name="Ames" placeholder="AMes Merchant ID "
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="pid" placeholder="Premium ID"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="mcc" placeholder="MCC"
                                       value="<c:out value="${user.getMCC()}" />">
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            <div class="col-sm-offset-4 col-sm-8">
                                <input type="button" value="<fmt:message key="Submit" />" id="submit"
                                       class="btn btn-primary" onclick="updateMerchant()"/>
                                <input type="reset" value="<fmt:message key="Cancel" />" name="cancel"
