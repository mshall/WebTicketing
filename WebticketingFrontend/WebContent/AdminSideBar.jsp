		...
		<ul class="list-unstyled components">
			...
			<li><a href="#homeSubmenu" data-toggle="collapse"
				...
				<ul class="collapse list-unstyled" id="homeSubmenu">
					...
					<li><a href="Merchant.jsp"><fmt:message key="merchant" />
					</a></li>
			...
			<li><a href="#SIM" data-toggle="collapse" aria-expanded="false">
					<i class="glyphicon glyphicon-duplicate"></i> <fmt:message
						key="sim" />
			</a>
				<ul class="collapse list-unstyled" id="SIM">
					<li><a href="SIM.jsp"> <fmt:message key="sim" />
					</a></li>
				</ul></li>
			<li><a href="#RollPaper" data-toggle="collapse"
				...
				<ul class="collapse list-unstyled" id="RollPaper">
					<li><a href="MerchantRP.jsp"><fmt:message
								key="store_to_merchant" /></a></li>
				</ul></li>
			<li><a href="#Tickets" data-toggle="collapse"
				...
				<ul class="collapse list-unstyled" id="Tickets">
					<li><a href="InboxTickets.jsp"><fmt:message
								key="inbox_tickets" /></a></li>
					<li><a href="AssignTicket.jsp"><fmt:message
								key="assign_ticket" /></a></li>
			...
			<li><a href="#Withdraw" data-toggle="collapse"
				...
				<ul class="collapse list-unstyled" id="Withdraw">
					...
					<li><a href="WithDraw.jsp"><fmt:message
								key="add_new_withdraw" /></a></li>
					<li><a href="WithDrawLogs.jsp"><fmt:message
								key="withDraw_logs" /> </a></li>
				</ul></li>
			<li><a href="#Reports" data-toggle="collapse"
				...
				<ul class="collapse list-unstyled" id="Reports">
					<li><a href="TerminalReport.jsp"><fmt:message
								key="pos_report" /></a></li>
					<li><a href="SimReport.jsp"><fmt:message key="sim_report" /></a></li>
					<li><a href="MaintenanceReport.jsp"><fmt:message
								key="maintenance_report" /></a></li>
					<li><a href="DeploymentReport.jsp"><fmt:message
								key="deployment_report" /></a></li>
					<li><a href="TicketReport.jsp"><fmt:message
								key="tickets_report" /></a></li>
					<li><a href="WdReport.jsp"><fmt:message
								key="withdrawals_report" /></a></li>
					<li><a href="RpReport.jsp"><fmt:message
